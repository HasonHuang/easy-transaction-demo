 ...
 CREATE TABLE `easytrans-order`.`trx_executed_trans` (
...
CREATE TABLE `easytrans-order`.`trx_idempotent` (
...
CREATE TABLE `easytrans-order`.`trx_trans_log_detail` (
...
CREATE TABLE `easytrans-order`.`trx_trans_log_unfinished` (
  `trans_log_id` binary(12) NOT NULL,
  `create_time` datetime NOT NULL,
...
CREATE TABLE `easytrans-order`.`trx_election` (
...
CREATE TABLE `easytrans-order`.`trx_str_codec` (
  `key_int` int(11) NOT NULL,
  `type_str` varchar(45) NOT NULL,
  `value_str` varchar(500) NOT NULL,
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`key_int`),
...
# ======================= account =======================#
    ...
    -- 记录存在，但status为2表示本方法存在父事务，且父事务的最终状态未知
    -- 父事务的状态将由发起方通过 优先同步告知 失败则 消息形式告知
 CREATE TABLE `easytrans-account`.`trx_executed_trans` (
  `app_id` smallint(5) unsigned NOT NULL,
  `bus_code` smallint(5) unsigned NOT NULL,
  `trx_id` bigint(20) unsigned NOT NULL,
  `p_app_id` smallint(5) unsigned DEFAULT NULL,
...
CREATE TABLE `easytrans-account`.`trx_idempotent` (
  `src_app_id` smallint(5) unsigned NOT NULL COMMENT '来源AppID',
  `src_bus_code` smallint(5) unsigned NOT NULL COMMENT '来源业务类型',
  `src_trx_id` bigint(20) unsigned NOT NULL COMMENT '来源交易ID',
  `app_id` smallint(5) NOT NULL COMMENT '调用APPID',
...
CREATE TABLE `easytrans-account`.`trx_trans_log_detail` (
  `log_detail_id` int(11) NOT NULL AUTO_INCREMENT,
  `trans_log_id` binary(12) NOT NULL,
  `log_detail` blob,
  `create_time` datetime NOT NULL,
...
CREATE TABLE `easytrans-account`.`trx_trans_log_unfinished` (
  `trans_log_id` binary(12) NOT NULL,
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`trans_log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `easytrans-account`.`trx_election` (
  `app_id` varchar(64) NOT NULL COMMENT 'AppId',
  `instance_id` int(11) NOT NULL COMMENT '实例id，递增',
  `heart_beat_time` datetime NOT NULL COMMENT '上次master发送心跳的时间',
  `instance_name` varchar(255) DEFAULT NULL COMMENT '当前实例的名称',
...
CREATE TABLE `easytrans-account`.`trx_str_codec` (
  `key_int` int(11) NOT NULL,
  `type_str` varchar(45) NOT NULL,
  `value_str` varchar(500) NOT NULL,
  `create_time` datetime NOT NULL,
