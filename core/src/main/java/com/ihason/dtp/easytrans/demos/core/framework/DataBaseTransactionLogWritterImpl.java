package com.ihason.dtp.easytrans.demos.core.framework;
...
public class DataBaseTransactionLogWritterImpl implements TransactionLogWritter {
    ...
    public DataBaseTransactionLogWritterImpl(ObjectSerializer objectSerializer,DataSource dataSource, ByteFormIdCodec idCodec,String tablePrefix) {
        this(new DataSourceTransactionManager(dataSource), objectSerializer, dataSource, idCodec, tablePrefix);

    }

    public DataBaseTransactionLogWritterImpl(DataSourceTransactionManager transactionManager, ObjectSerializer objectSerializer,DataSource dataSource, ByteFormIdCodec idCodec,String tablePrefix) {
        super();
